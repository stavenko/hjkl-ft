...
#   * ВНУТРЕННЯЯ СВЕРКА — сумма трёх долей обязана быть 90–100, АЛК ≤ ПНЖК,
#     EPA+DHA ≤ ПНЖК. Это проверка без справочника, и она ловит бессмыслицу сразу.
#
...
# Диапазоны — в процентах от общего жира: НЖК / МНЖК / ПНЖК, затем АЛК и EPA+DHA.
...
TABLE='  coconut_palm         SFA 82–92, MUFA 5–12, PUFA 1–3, ALA 0, EPA+DHA 0 — кокосовое масло, пальмовое масло, кокосовая стружка, кокосовое молоко, пальмоядровый жир
  dairy_fat            SFA 60–70, MUFA 22–30, PUFA 2–6, ALA 0–1, EPA+DHA 0 — сливочное масло, топлёное масло, сливки, сметана, сыр, молоко, творог, мороженое, кефир
  beef_lamb_fat        SFA 38–48, MUFA 40–50, PUFA 2–6, ALA 0–1, EPA+DHA 0 — говядина, телятина, баранина, курдючное сало, говяжий жир, субпродукты жвачных
  pork_fat             SFA 33–40, MUFA 42–50, PUFA 8–14, ALA 0–1, EPA+DHA 0 — свинина, сало, шпик, бекон, ветчина, колбаса, сосиски, свиные субпродукты
  poultry_fat          SFA 26–32, MUFA 40–48, PUFA 18–26, ALA 0–2, EPA+DHA 0–1 — курица, индейка, утка, гусь, куриная кожа, куриный жир, куриная печень
  egg_fat              SFA 28–34, MUFA 40–48, PUFA 12–18, ALA 0–1, EPA+DHA 0–2 — яйцо, яичный желток, омлет, яичница
  olive_avocado        SFA 12–18, MUFA 65–75, PUFA 10–16, ALA 0–1, EPA+DHA 0 — оливковое масло, оливки, маслины, авокадо, масло авокадо
  rapeseed_mustard     SFA 6–9, MUFA 58–66, PUFA 26–32, ALA 8–11, EPA+DHA 0 — рапсовое масло, каноловое масло, горчичное масло, семена горчицы
  peanut               SFA 15–20, MUFA 45–55, PUFA 25–35, ALA 0, EPA+DHA 0 — арахис, арахисовое масло, арахисовая паста
  seed_oils_linoleic   SFA 10–15, MUFA 18–28, PUFA 55–68, ALA 0–8, EPA+DHA 0 — подсолнечное масло, кукурузное масло, соевое масло, масло виноградных семечек, семечки подсолнуха, тыквенные семечки, кунжут, майонез, маргарин
  high_oleic_oils      SFA 7–12, MUFA 75–85, PUFA 5–12, ALA 0, EPA+DHA 0 — высокоолеиновое подсолнечное, высокоолеиновое сафлоровое, олеиновый подсолнечник
  flax_chia            SFA 8–11, MUFA 15–22, PUFA 66–75, ALA 50–60, EPA+DHA 0 — льняное масло, семена льна, семена чиа, рыжиковое масло
  walnut_hemp          SFA 9–12, MUFA 13–22, PUFA 65–75, ALA 10–18, EPA+DHA 0 — грецкий орех, конопляное семя, масло грецкого ореха
  fish_fatty_cold      SFA 20–28, MUFA 30–45, PUFA 20–30, ALA 0–2, EPA+DHA 12–25 — скумбрия, сельдь, лосось, форель, сардина, шпроты, анчоус, икра, рыбий жир, печень трески
  fish_lean_seafood    SFA 18–25, MUFA 12–20, PUFA 30–45, ALA 0–2, EPA+DHA 25–40 — треска, минтай, судак, тунец, креветки, мидии, кальмар, гребешок, крабовые палочки
  fish_warm_low_n3     SFA 25–35, MUFA 25–40, PUFA 20–30, ALA 0–2, EPA+DHA 3–8 — тилапия, пангасиус, баса, дорадо, сибас, карп, толстолобик, сом — тепловодная и прудовая рыба, у неё преобладает линолевая, а не n-3
  nuts_tree            SFA 7–14, MUFA 55–70, PUFA 15–30, ALA 0–1, EPA+DHA 0 — миндаль, фундук, кешью, фисташки, кедровый орех, бразильский орех, макадамия
  cocoa_confectionery  SFA 55–65, MUFA 28–35, PUFA 2–5, ALA 0, EPA+DHA 0 — шоколад, какао, какао-масло, конфеты, вафли, печенье, торт, кондитерский жир
  grain_legume         SFA 15–22, MUFA 12–25, PUFA 45–60, ALA 2–10, EPA+DHA 0 — крупы, хлеб, макароны, рис, овсянка, бобовые, чечевица, нут, соя, тофу
  no_fat               all zero — овощи, фрукты, зелень, сахар, мёд, вода, чай, кофе, алкоголь, желатин, специи — всё, где жира практически нет'

SCHEMA='{"$schema":"https://json-schema.org/draft/2020-12/schema","title":"FattyAcidProfile","type":"object","properties":{"category":{"description":"The category key from the table, copied EXACTLY as written there.","type":"string"},"food_type":{"description":"What this product actually is, in two or three words.","type":"string"},"sfa_pct":{"description":"SATURATED fatty acids as a PERCENT OF THIS FOOD'"'"'S TOTAL FAT, by weight. Not per 100 g of food.","type":"number","format":"double"},"mufa_pct":{"description":"MONOUNSATURATED fatty acids as a PERCENT OF THIS FOOD'"'"'S TOTAL FAT, by weight.","type":"number","format":"double"},"pufa_pct":{"description":"POLYUNSATURATED fatty acids as a PERCENT OF THIS FOOD'"'"'S TOTAL FAT, by weight.","type":"number","format":"double"},"ala_pct":{"description":"ALPHA-LINOLENIC acid (ALA, 18:3 n-3) as a PERCENT OF THIS FOOD'"'"'S TOTAL FAT. Part of pufa_pct, so it can never exceed it. Zero for most foods.","type":"number","format":"double"},"epa_dha_pct":{"description":"EPA plus DHA together as a PERCENT OF THIS FOOD'"'"'S TOTAL FAT. Part of pufa_pct, so it can never exceed it. Zero for everything except fish, seafood and fish oil.","type":"number","format":"double"},"confidence":{"description":"How sure you are of this profile, from 0.0 to 1.0. Be honest: 1.0 means you know THIS food'"'"'s fat profile, 0.0 means you are guessing from the category alone.","type":"number","format":"double"},"reason":{"description":"One short sentence: why this category and this profile. Keep it under 20 words.","type":"string"}},"required":["category","food_type","sfa_pct","mufa_pct","pufa_pct","ala_pct","epa_dha_pct","confidence","reason"]}'

FOODS=()
while IFS= read -r l; do [ -n "$l" ] && FOODS+=("$l"); done < "${FOODS_FILE:?нужен FOODS_FILE}"

printf '%-34s %-14s %-22s %-22s %-22s %-9s %-9s %5s %-20s\n' \
  "продукт" "ориентир" "НЖК мед(min–max)" "МНЖК мед(min–max)" "ПНЖК мед(min–max)" "АЛК" "EPA+DHA" "ошиб" "категория"
printf '%s\n' "--------------------------------------------------------------------------------------------------------------------------------------------------------"
...
- ala_pct: alpha-linolenic acid (18:3 n-3), percent of total fat, inside the row's ALA range. It is PART of pufa_pct and can never exceed it.
...
Base the answer only on the food name \"$name\". Respond with ONLY a single minified JSON object and nothing else — no markdown, no prose."
  ...
  sfa=(); mufa=(); pufa=(); ala=(); epa=(); cats=""; errs=0; bad=""
  for i in $(seq 1 "$N"); do
    ...
    v=$(echo "$c" | jq -r '[.sfa_pct, .mufa_pct, .pufa_pct, .ala_pct, .epa_dha_pct, .category] | @tsv' 2>/dev/null)
    if [ -z "$v" ] || [ "$(echo "$v" | cut -f1)" = "null" ]; then errs=$((errs+1)); continue; fi
    IFS=$'\t' read -r s m p a e k <<< "$v"
    sfa+=("$s"); mufa+=("$m"); pufa+=("$p"); ala+=("$a"); epa+=("$e"); cats="$cats$k "
    # Внутренняя сверка: сумма долей и вложенность АЛК/EPA+DHA в ПНЖК.
    flag=$(jq -n --argjson s "$s" --argjson m "$m" --argjson p "$p" --argjson a "$a" --argjson e "$e" '
      ...
      [ (if ($s+$m+$p) > 100 then "сумма=\(($s+$m+$p)*10|round/10)" else empty end),
        (if $a > $p then "АЛК>ПНЖК" else empty end),
        (if $e > $p then "EPA>ПНЖК" else empty end),
        (if ($a+$e) > $p then "АЛК+EPA>ПНЖК" else empty end) ] | join(",")')
    flag=$(echo "$flag" | tr -d '"')
    [ -n "$flag" ] && bad="$bad$flag; "
  done

  if [ ${#sfa[@]} -eq 0 ]; then
    printf '%-34s %-14s %-22s %-22s %-22s %-9s %-9s %5d %-20s\n' "$name" "$ref" "—" "—" "—" "—" "—" "$errs" "—"
    continue
  fi
  st() { printf '%s\n' "$@" | sort -g | jq -s -r '
