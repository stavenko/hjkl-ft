...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "pwa.unknown.copy_hint" => "To do that, copy this address:",
        "pwa.unknown.steps" => "Launch Chrome.\nAnd type the address into the search bar.",
...
fn ru(key: &str) -> &'static str {
    match key {
        ...
        "pwa.unknown.copy_hint" => "Для этого скопируйте этот адрес:",
        "pwa.unknown.steps" => "Запустите Chrome.\nИ введите адрес в строку поиска.",
