...
const redMeatPrompt = (name, identity) =>
  `A person wrote this into their food diary: ${name}\n\n` +
  `Our automatic classifier says this product is: ${identity}\n\n` +
  "Is this product a LIVER, a HEART of an animal, the MUSCLE TISSUE of a mammal, or OSTRICH " +
  "meat?\n\n" +
  "A tongue is muscle tissue. Sausage, ham and jamon made mainly of mammal meat are muscle " +
  "tissue too. Liver sausage and pâté made mainly of liver count as liver. The liver and the " +
  "heart in question are those of a MAMMAL or a BIRD: fish liver, such as cod liver, is not " +
  "this, and neither is fish roe. Birds are not mammals — chicken, turkey, duck and goose are " +
  "none of these, and so are their gizzards; the ostrich has its own answer. Fish, seafood, " +
  "eggs, dairy and plants are none of these.\n\n" +
  "Answer with ONE word: LIVER, HEART, MAMMAL_MUSCLE, OSTRICH or OTHER.\n\n" +
...
for (const [name, want] of CASES) {
  ...
  const r = await ask(redMeatPrompt(name, top.definition), redMeatSchema, "red_meat");
  ...
  console.log(`${ok ? "OK  " : "MISS"} ${name.padEnd(26)} ${got.padEnd(16)} ${isRedMeat ? "да " : "нет"}           ${top.definition}`);
