...
const F = (name, price, o) => ({
  name, price, pack: null, kcal: 0, protein: 0, fat: 0, fibre: 0, calcium: 0, iron: 0,
...
export const FOODS = {
  ...
  chickenThigh: F("Куриное бедро (без кости)", 532,
    { pack: "Ярославский бройлер, бедро цыплёнка-бройлера, 750 г — 399 ₽",
  ...
  chickenBreast: F("Куриная грудка", 572,
    { pack: "Первая свежесть, грудка цыплёнка-бройлера, 750 г — 429 ₽",
  ...
  chickenLiver: F("Печень куриная", 411,
    { pack: "Первая Свежесть, печень куриная охлаждённая, 450 г — 185 ₽",
  ...
  herring: F("Сельдь атлантическая (филе)", 695,
    { pack: "Экстра Фиш, филе сельди слабосолёное, 200 г — 139 ₽",
  ...
  kefir: F("Кефир 2.5%", 113,
    { pack: "Простоквашино, кефир 2,5 %, 930 г — 105 ₽",
  ...
  cheese: F("Сыр полутвёрдый 45%", 995,
    { pack: "Брест-Литовск, сыр Финский 45 %, 200 г — 199 ₽",
  ...
  teos: F("Греческий йогурт Teos 2%", 564,
    { pack: "Teos, йогурт греческий густой 2 %, 140 г — 79 ₽",
      kcal: 66, protein: 9, fat: 2, calcium: 120, iron: 0.1,
      sfa: 64, mufa: 28, pufa: 4, globule: true }),
  cottage: F("Творог 5%", 417,
    { pack: "Константиново, творог 5 %, 180 г — 75 ₽",
  ...
  egg: F("Яйцо куриное", 194,
    { pack: "Ozon fresh, яйцо куриное столовое С1, 10 шт — 99 ₽",
  ...
  buckwheat: F("Гречка", 97,
    { pack: "Агро-Альянс, гречневая крупа ядрица, 900 г — 87 ₽",
  ...
  lentils: F("Чечевица", 193,
    { pack: "Увелка, чечевица красная, 450 г — 87 ₽",
  ...
  syrok: F("Сырок глазированный", 924,
    { pack: "Ростагроэкспорт, сырок творожный глазированный с ванилью 20 %, 12 × 45 г — 499 ₽",
  ...
  sunflowerOil: F("Масло подсолнечное", 154,
    { pack: "Золотая Семечка, масло подсолнечное рафинированное, 1 л — 142 ₽",
  ...
  sunflowerSeeds: F("Семечки подсолнечника", 240,
    { pack: "Семечки подсолнечника очищенные сырые, 500 г — 120 ₽",
  ...
  pumpkinSeeds: F("Семечки тыквенные", 988,
    { pack: "Ореховец, семена тыквы очищенные, 500 г — 494 ₽",
...
export function evaluate(basket, { kcal, sex, weight, height, age }) {
  ...
  for (const [key, grams] of Object.entries(basket)) {
    ...
    sum.price += cost;
    rows.push({ key, name: f.name, grams, day: Math.round(grams / 7), cost, pack: f.pack });
  }
