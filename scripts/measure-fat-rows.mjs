...
const CASES = [
  ...
  // Овощи: боевые отказы 21.08 — модель называла строку «vegetable», такой не
  // было, и продукт уходил в ошибку «unknown fat row». Жира в них практически
  // нет, поэтому все доли нулевые.
  ["Цветная капуста", 0.3, [0, 0, 0, 0], "овощ: строка vegetable_fruit_no_fat"],
  ["Перец болгарский", 0.3, [0, 0, 0, 0], "овощ: строка vegetable_fruit_no_fat"],
  // Снек, обжаренный в масле: боевой случай 21.08 — модель называла строку
  // «seaweed», «seaweed_snacks», «seaweed_based_chips», и продукт уходил в ошибку.
  // Жир здесь из МАСЛА, а не из водоросли.
  ["SPAR Чипсы нори", 30, [11, 20, 66, 0], "чипсы в подсолнечном масле"],
];
