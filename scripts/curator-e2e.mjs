...
//   5. куратор просит данные за срок; худеющий шлёт отчёт со всем, что нужно
//      для расчёта; отчёт лёг в слот и доехал в целости
//   6. куратор ставит планку ЧИСЛОМ — директива в треде, без замка
