...
const BASKET = {
  chickenThigh: 1400,      // 200 г/день
  chickenLiver: 300,       // два раза по 150 г
  mussels: 0,              // по желанию — см. вывод
  herring: 300,            // два раза по 150 г
  egg: 350,                // семь яиц
  kefir: 3500,             // 500 мл/день
  cottage: 700,            // 100 г/день
  cabbage: 2100,           // 300 г/день
  carrot: 1050,            // 150 г/день
  beet: 700,               // 100 г/день
  apple: 1050,             // 150 г/день
  frozenVeg: 700,          // 100 г/день
  barley: 700,             // 100 г/день сухой
  lentils: 900,            // ~130 г/день сухой — самый дешёвый белок в корзине
  sunflowerOil: 70,        // 10 г/день — калории освобождены под чечевицу
  sunflowerSeeds: 210,     // 30 г/день
  walnuts: 0,
};
