...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "food_editor.food_photo_draft_hint" => "Draft — this is how a photographed dish is broken into products. Recognition isn't wired up yet.",
...
fn ru(key: &str) -> &'static str {
    match key {
        ...
        "food_editor.food_photo_draft_hint" => "Черновик — так сфотографированное блюдо разбивается на продукты. Само распознавание пока не подключено.",
