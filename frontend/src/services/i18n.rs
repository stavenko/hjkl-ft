...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "curator.note.planka_changed" => "Your curator changed your {what}",
        "curator.note.lock_on" => "Your curator switched off automatic recalculation of your {what}",
        "curator.note.lock_off" => "Your curator switched automatic recalculation of your {what} back on",
        ...
        "curator.letter.lock_on" => "Your curator switched off automatic recalculation of your {what}.\n\nFrom now on it changes only when your curator changes it.",
        "curator.letter.lock_off" => "Your curator switched automatic recalculation of your {what} back on.\n\nThe app will keep adjusting it again.",
        "curator.letter.unbound" => "You and your curator are no longer working together.\n\nYour targets stay as they are. In a week the app will start recalculating them itself, as it did before. You can recalculate them right now instead.",
        ...
        "curator.report.requested" => "Your curator is asking for your data for the last {days} day(s).",
        "curator.report.send_requested" => "Send what was asked ({days} d.)",
        "curator.report.last_sent" => "Last report sent on {date}.",
        "curator.report.never_sent" => "You have not sent a report yet.",
        "curator.report.days_hint" => "days to include",
        "curator.report.send" => "Send report",
        "curator.report.bad_period" => "Period must be between 1 and 366 days",
...
fn ru(key: &str) -> &'static str {
    match key {
        ...
        "curator.note.planka_changed" => "Куратор изменил вам {what}",
        "curator.note.lock_on" => "Куратор запретил автоматический пересчёт: {what}",
        "curator.note.lock_off" => "Куратор снова разрешил автоматический пересчёт: {what}",
        ...
        "curator.letter.lock_on" => "Ваш куратор запретил автоматический пересчёт: {what}.\n\nТеперь она меняется только тогда, когда её меняет куратор.",
        "curator.letter.lock_off" => "Ваш куратор снова разрешил автоматический пересчёт: {what}.\n\nПриложение снова будет её вести.",
        "curator.letter.unbound" => "Работа с куратором прекращена.\n\nПланки остаются как есть. Через неделю приложение снова начнёт пересчитывать их само, как делало раньше. Можно не ждать и пересчитать прямо сейчас.",
        ...
        "curator.report.requested" => "Куратор запрашивает ваши данные за последние {days} дн.",
        "curator.report.send_requested" => "Отправить запрошенное ({days} дн.)",
        "curator.report.last_sent" => "Последний отчёт отправлен {date}.",
        "curator.report.never_sent" => "Вы ещё не отправляли отчёт.",
        "curator.report.days_hint" => "дней в отчёте",
        "curator.report.send" => "Отправить отчёт",
        "curator.report.bad_period" => "Срок — от 1 до 366 дней",
