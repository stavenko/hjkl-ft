...
fn egg_hint_text() -> String {
    ...
    format!(
        "Яйцо — эталон белка: по усвояемости и составу аминокислот оно превосходит мясо, \
         ...
         Считаем по белку: в одном яйце {:.1} г, и по нему число яиц восстанавливается из \
         любой записи — яичницы, омлета, запеканки. В блюдах засчитываются сами яйца, а не \
         вся тарелка. Майонез и салаты с яйцом сюда не идут: долю яйца в них не восстановить.",
        egg::WEEKLY_MIN_EGGS,
        egg::PROTEIN_PER_EGG_G,
    )
}
