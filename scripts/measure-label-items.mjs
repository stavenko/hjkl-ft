...
//
//   node scripts/measure-label-items.mjs [--n 3] [--case сметана|оливки|творог|курица|сырок] [--single 1|2]
//
...
const PROMPT_MASS =
  ...
  `- Масса бывает в КИЛОГРАММАХ («Масса нетто 0,430 кг») — переведи в граммы, grams всегда в граммах.\n` +
