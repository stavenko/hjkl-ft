...
//
//   node scripts/measure-label-items.mjs [--n 3] [--case сметана|оливки|творог|курица|йогурт]
//                                         [--single 1|2]
//
...
//
// Эталоны вычитаны со снимков вручную.
//
// Здесь был ещё один кейс — глазированный сырок. Он снят по диагонали на
// цилиндрической бликующей плёнке, и прочесть его не удалось ничем: ни моделью в
// двух разрешениях, ни разметкой через саму модель, ни классическим выделением
// блоков текста. Снимок убран, а случай отдан человеку: не прочли — говорим об
// этом прямо и просим переснять.
