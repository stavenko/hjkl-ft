...
const ctx = await b.newContext({ viewport: { width: 430, height: 900 }, serviceWorkers: "block", recordVideo: { dir: "/tmp/story6-vid", size: { width: 430, height: 900 } } });
...
await page.waitForTimeout(4200); // stay on frame 6 so the highlight GIF loops
