...
#[component]
pub fn StoryCh3AestheticsPage() -> impl IntoView {
    let navigate = use_navigate();

    let paragraphs =
        ["story.ch3.aesthetics.p1", "story.ch3.aesthetics.p2", "story.ch3.aesthetics.p3"];
    ...
    view! {
        <div style=PAGE_BG>
            ...
            <h1 class="is-size-1 has-text-weight-bold" style="margin: 0 16px 16px 16px;">{move || t("story.ch3.aesthetics")}</h1>
