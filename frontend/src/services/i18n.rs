...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "locked.body" => "This account has no active subscription.\n\nTo renew it, open the Telegram bot.",
...
fn ru(key: &str) -> &'static str {
    match key {
        ...
        "locked.body" => "На вашем аккаунте нет активной подписки.\n\nЕсли вы хотите возобновить подписку, вам нужно перейти в Telegram-бота.",
