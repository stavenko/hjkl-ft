...
#[component]
pub fn StoryCh3LeanPage() -> impl IntoView {
    let navigate = use_navigate();

    let paragraphs = ["story.ch3.lean.p1", "story.ch3.lean.p2", "story.ch3.lean.p3"];
    ...
    view! {
        <div style=PAGE_BG>
            ...
            <h1 class="is-size-1 has-text-weight-bold" style="margin: 0 16px 16px 16px;">{move || t("story.ch3.s4")}</h1>
