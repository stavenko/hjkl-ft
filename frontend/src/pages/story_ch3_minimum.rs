...
#[component]
pub fn StoryCh3MinimumPage() -> impl IntoView {
    let navigate = use_navigate();

    let paragraphs = ["story.ch3.minimum.p1", "story.ch3.minimum.p2", "story.ch3.minimum.p3"];
    ...
    view! {
        <div style=PAGE_BG>
            ...
            <h1 class="is-size-1 has-text-weight-bold" style="margin: 0 16px 16px 16px;">{move || t("story.ch3.s3")}</h1>
