...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "dashboard.height_hint" => "Height in centimetres — 80 to 250.",
        "dashboard.birth_year_hint" => "The full year, e.g. 1990.",
        "dashboard.persona_missing" => "To continue, fill in:",
        "dashboard.goal" => "Goal",
...
fn ru(key: &str) -> &'static str {
    match key {
        ...
        "dashboard.height_hint" => "Рост в сантиметрах — от 80 до 250.",
        "dashboard.birth_year_hint" => "Год целиком, например 1990.",
        "dashboard.persona_missing" => "Чтобы продолжить, заполните:",
        "dashboard.goal" => "Цель",
