...
#[component]
pub fn StoryCh3LifestylePage() -> impl IntoView {
    let navigate = use_navigate();

    let paragraphs = ["story.ch3.lifestyle.p1", "story.ch3.lifestyle.p2", "story.ch3.lifestyle.p3"];
    ...
    view! {
        <div style=PAGE_BG>
            ...
            <h1 class="is-size-1 has-text-weight-bold" style="margin: 0 16px 16px 16px;">{move || t("story.ch3.s5")}</h1>
