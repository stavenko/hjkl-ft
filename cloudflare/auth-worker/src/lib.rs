...
async fn main(req: Request, env: Env, _ctx: Context) -> Result<Response> {
    ...
    let result = router
        ...
        .post_async("/recovery/phrase/set", recovery::set_phrase)
        .get_async("/recovery/phrase", recovery::get_phrase)
        .post_async("/recovery/phrase/login", recovery::login_with_phrase)
