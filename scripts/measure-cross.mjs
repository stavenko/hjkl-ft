...
const CASES = [
  ...
  // ИМЕНА ИЗ БОЕВОЙ СВОДКИ «не опознано за сутки» (21.08.2026). Половина из них —
  // обычная еда, которую гейт перестал пропускать после правки промпта опознания,
  // поэтому они здесь навсегда: набор должен ловить такое сам, без ночного письма.
  ["Кабачок", true, false, false, false, false],
  ["Банан", true, false, false, false, false],
  ["Груша Аббат", true, false, false, false, false],
  // Корнеплоды ВХОДЯТ в планку овощей и фруктов: 800 г редиски — это 800 г овощей.
  // Признак корня остаётся в разборе продукта, но больше ничего не фильтрует.
  ["Редиска", true, false, false, false, false],
  // Картофель и морковь — то же правило, и картофель здесь НАРОЧНО: он самый
  // спорный из корнеплодов, и его «да» — прямое следствие принятого решения, а не
  // недосмотр. Крахмал (ниже) остаётся «нет»: выжимка вообще не часть растения.
  ["Картофель отварной", true, false, false, false, false],
  ["Морковь", true, false, false, false, false],
  ["огурец", true, false, false, false, false],
  ["Салат фриллис", true, false, false, false, false],
  ["Крахмал", false, false, false, false, false],
  ["Русский хлеб", false, false, false, false, false],
  ["Спиральчатый спагетти", false, false, false, false, false],
  ["Козинак подсолнечный", false, false, false, false, false],
  ["Балтика 0.0", false, false, false, false, false],
  // Птица: в гем идёт ОРГАН (сердце, печень, желудки), а не мякоть. Грудка — мясо
  // птицы, и по нашему правилу это не богатый источник гема: «Not a mammal meat,
  // organ, or mollusc». Эталон «да» у грудки был ошибкой.
  ["Куриная грудка филе без кожи", false, false, false, false, false],
  ["Сердце цыплят-бройлеров", false, true, false, false, false],
  // Моллюски идут в гем наравне с мясом и печенью (см. `iron_absorption`).
  ["Мидии чилийские варено-мороженые", false, true, false, false, false],
  // Молочное с ЦЕЛОЙ глобулой: творог и сыры — да, в отличие от масла.
  // Обезжиренный творог: глобуле не в чем быть — «No milk fat present». Жирный
  // творог и сыры ниже — другое дело.
  ["Творог обезжиренный «Нежинская»", false, false, false, false, false],
  ["Моцарелла Норд", false, false, false, false, true],
  ["Экомилк Творожный сыр", false, false, false, false, true],
];
