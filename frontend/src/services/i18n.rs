...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "help.food.where_text" => "Open the «Diary» tab in the bottom menu. On today's day there's a green round «+» button at the bottom right — tap it to add food.",
        "help.food.methods_title" => "Ways to log food",
        "help.food.search_title" => "Search the database",
        "help.food.search_text" => "Start typing a name — the app suggests matching items from the database. Pick one and enter the weight.",
        "help.food.ai_title" => "AI request",
        "help.food.ai_text" => "Describe the meal in words (e.g. «a two-egg omelette and a toast») — the AI breaks it into products and computes the calories/protein/fat/carbs. Just review and save.",
        "help.food.photo_title" => "Photo & recognition",
        "help.food.photo_text" => "Take a photo of the food or a label — the app recognises the contents and adds them to the diary.",
        "help.food.more_title" => "More",
        "help.link.copy_day" => "How to copy food from a past day",
        "help.link.add_food" => "How to add food",
        ...
        "help.article.copy_day.p2" => "Tap «⋮» on an entry and choose «Repeat today» — the food is copied into today.",
        "help.article.add_food.p1" => "On the «Diary» tab, on today's day, tap the green «+» button.",
        "help.article.add_food.p2" => "Then choose an input method — database search, an AI request, or a photo.",
        "help.article.recipes.p1" => "Open the «Recipes» tab and tap «Create».",
        "help.article.recipes.p2" => "Add ingredients with their weight and set the final weight of the cooked dish — the app computes the calories/protein/fat/carbs per 100 g. You then log the dish in the diary like any food.",
        "help.article.delete_food.p1" => "Tap «⋮» on an entry in the diary and choose «Delete».",
        "help.article.edit_weight.p1" => "Tap «⋮» on an entry and choose «Edit».",
        "help.article.edit_weight.p2" => "Change the weight — the calories/protein/fat/carbs recompute automatically.",
        "help.article.rename_food.p1" => "Tap «⋮» on an entry, choose «Edit», then change the name.",
        "help.article.rename_food.p2" => "The change makes your own copy of the product and doesn't affect the original item in the database.",
        "cycle.title" => "Cycle",
        "cycle.day_label" => "Day",
        "cycle.not_set" => "—",
        ...
        "story.ch4.amount.p1" => "According to the WHO, to avoid dying a person must eat at least 0.8 grams per kilogram of body weight.",
        "story.ch4.amount.p2" => "This is the minimum threshold, below which protein intake simply must not drop. Otherwise, besides the external problems — when skin, nails and hair start to look bad — problems with the cells' performance arise.",
        "story.ch4.amount.p3" => "But this is exactly the minimum threshold. At this threshold we can talk about survival, but not about health.",
        "story.ch4.amount.p4" => "An average person living their life needs to consume at least 1.2 g of protein per kilogram of body weight. This is the very minimum that gives health.",
        "story.ch4.amount.p5" => "However, once a person starts losing weight, their goal is not only to shed excess fat mass but also to preserve muscle. That's exactly why we recommend gentle deficits. The kind that work slowly, but without risk to muscle tissue. Protein intake at the level of 1.6 g per kilogram of body weight also protects muscle tissue.",
        "story.ch4.amount.p6" => "That's exactly how much we recommend. And that's exactly how we calculated your protein target.",
        "story.ch4.amount.p7" => "You only have to stick to it with discipline and eat your target every day. We'll help you with that!",
        "story.ch4.sources.h1" => "Where to get protein?",
        "story.ch4.sources.p1" => "There is a huge number of protein sources, both plant and animal. Plant ones are absorbed a bit worse, animal ones a bit better.",
        "story.ch4.sources.p2" => "What should guide your choice of a protein source?",
        "story.ch4.sources.p3" => "1. You need to eat enough dairy protein. You don't have to consume fatty products to do so. The protein is absorbed from fat-free dairy, while the extra fat won't eat into your calorie budget.",
        "story.ch4.sources.p4" => "2. Animal products low in fat. The classic chicken breast, turkey breast, tuna in its own juice, egg white, lean beef. These products, if cooked well and properly, are very filling and make up the base and foundation of your diet.",
        "story.ch4.sources.p5" => "3. Seafood: shrimp, mussels, squid. These sources are often high in cholesterol, so we recommend eating them infrequently. But it's the kind of product that lets you easily close your daily protein target.",
        "story.ch4.sources.p6" => "4. If you're against eating animal products, try protein from legumes — mung beans, edamame, chickpeas. Sources with a good profile from soy, such as tofu, or from wheat, such as seitan.",
        "story.ch4.sources.p7" => "You'll have to carefully fit all these sources into your diet. You can try starting with the most ordinary things and see how tasty you find them.",
        "story.ch4.sources.p8" => "Your task within this course is to replace highly processed products with minimally processed ones that have a low calorie density.",
        "story.ch4.sources.p9" => "Calorie counting will help you with this, if only because you'll want to simplify the cooking process.",
...
fn ru(key: &str) -> &'static str {
    match key {
        ...
        "help.food.where_text" => "Откройте вкладку «Дневник» в нижнем меню. На сегодняшнем дне внизу справа есть зелёная круглая кнопка «+» — нажмите её, чтобы добавить еду.",
        "help.food.methods_title" => "Способы внести еду",
        "help.food.search_title" => "Поиск по базе",
        "help.food.search_text" => "Начните вводить название — программа предложит подходящие позиции из базы. Выберите нужную и укажите вес.",
        "help.food.ai_title" => "ИИ-запрос",
        "help.food.ai_text" => "Опишите приём пищи словами (например «омлет из двух яиц и тост») — ИИ разберёт блюдо на продукты и посчитает КБЖУ. Останется проверить и сохранить.",
        "help.food.photo_title" => "Фото и распознавание",
        "help.food.photo_text" => "Сфотографируйте еду или этикетку — программа распознает состав и добавит его в дневник.",
        "help.food.more_title" => "Ещё",
        "help.link.copy_day" => "Как скопировать еду из прошлого дня?",
        "help.link.add_food" => "Как добавить еду",
        ...
        "help.article.copy_day.p2" => "Нажмите «⋮» у записи и выберите «Повторить сегодня» — еда скопируется в сегодняшний день.",
        "help.article.add_food.p1" => "На вкладке «Дневник», на сегодняшнем дне, нажмите зелёную кнопку «+».",
        "help.article.add_food.p2" => "Затем выберите способ ввода — поиск по базе, ИИ-запрос или фото.",
        "help.article.recipes.p1" => "Откройте вкладку «Рецепты» и нажмите «Создать».",
        "help.article.recipes.p2" => "Добавьте ингредиенты с их весом и укажите итоговый вес готового блюда — программа посчитает КБЖУ на 100 г. Готовое блюдо потом вносится в дневник как обычная еда.",
        "help.article.delete_food.p1" => "Нажмите «⋮» у записи в дневнике и выберите «Удалить».",
        "help.article.edit_weight.p1" => "Нажмите «⋮» у записи и выберите «Изменить».",
        "help.article.edit_weight.p2" => "Поменяйте вес — КБЖУ пересчитаются автоматически.",
        "help.article.rename_food.p1" => "Нажмите «⋮» у записи и выберите «Изменить», затем поменяйте название.",
        "help.article.rename_food.p2" => "Изменение создаёт вашу копию продукта и не затрагивает исходную позицию в базе.",
        "cycle.title" => "Цикл",
        ...
        "story.ch4.amount.p1" => "По данным ВОЗ, человеку, чтобы не умереть, необходимо съедать как минимум 0,8 грамма на килограмм массы тела.",
        "story.ch4.amount.p2" => "Это минимальный порог, ниже которого опускать потребление белка просто нельзя. Иначе, кроме проблем внешних, когда кожа, ногти и волосы начинают выглядеть плохо, возникают проблемы работоспособности клеток.",
        "story.ch4.amount.p3" => "Однако это именно минимальный порог. На этом пороге можно говорить о выживании, но нельзя говорить о здоровье.",
        "story.ch4.amount.p4" => "Среднему человеку, который живёт свою жизнь, необходимо употреблять как минимум 1,2 г белка на килограмм массы тела. Это тот самый минимум, который даёт здоровье.",
        "story.ch4.amount.p5" => "Однако, если человек начинает худеть, то его целью является не только сброс лишней жировой массы, но и сохранение мышц. Именно поэтому мы рекомендуем щадящие дефициты. Такие, которые работают долго, но без риска для мышечной ткани. Также защищает мышечную ткань потребление белка на уровне 1,6 г на килограмм массы тела.",
        "story.ch4.amount.p6" => "Именно столько мы рекомендуем. И именно так мы посчитали вашу планку по белку.",
        "story.ch4.amount.p7" => "Вам остаётся только дисциплинированно придерживаться и каждый день съедать вашу норму. Мы вам будем в этом помогать!",
        "story.ch4.sources.h1" => "Откуда брать белок?",
        "story.ch4.sources.p1" => "Существует огромное количество белковых источников, как растительного, так и животного происхождения. Растительные усваиваются чуть хуже, животные — чуть лучше.",
        "story.ch4.sources.p2" => "Чем надо руководствоваться при выборе источника белка?",
        "story.ch4.sources.p3" => "1. Необходимо есть достаточно молочного белка. Необязательно при этом потреблять жирные продукты. Белок усвоится из обезжиренных молочных продуктов, а лишний жир не будет исчерпывать ваш бюджет по калориям.",
        "story.ch4.sources.p4" => "2. Животные продукты с низким количеством жира. Та самая куриная грудка, грудка индейки, тунец в собственном соку, яичный белок, постная говядина. Эти продукты, если их хорошо и правильно готовить, очень хорошо насыщают и являются базой и основой рациона.",
        "story.ch4.sources.p5" => "3. Морепродукты: креветки, мидии, кальмары. В этих источниках часто много холестерина, поэтому мы рекомендуем их есть нечасто. Но это тот продукт, который позволяет легко закрыть ежедневную планку по белку.",
        "story.ch4.sources.p6" => "4. Если вы против употребления животных продуктов, попробуйте белок из бобовых — фасоль маш, эдамаме, нут. Источники с хорошим профилем из сои, например тофу, или из пшеницы, например сейтан.",
        "story.ch4.sources.p7" => "Все эти источники вам придётся аккуратно вписать в свой рацион. Вы можете попробовать начать с наиболее банальных вещей и посмотреть, насколько вам вкусно.",
        "story.ch4.sources.p8" => "Ваша задача в рамках этого курса — заместить продукты высокой переработки на продукты низкой переработки с низкой калорийной плотностью.",
        "story.ch4.sources.p9" => "Подсчёт калорий вам в этом поможет хотя бы тем, что вам захочется упростить процесс готовки.",
